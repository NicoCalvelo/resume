...
export default function NavBar({ color }) {
  return (
    <nav
      ...
      className={
        "fixed shadow-xl backdrop-blur-lg left-1/3 right-1/3 top-2 z-50 transition-all ease-in-out duration-500 delay-300 py-2 rounded-full flex flex-row justify-between px-10"
      }
    >
      <Link href="/" passHref>
        <svg
